...
public:
    ...
    MOCK_METHOD(FileStatus_e, write, (ManagerId_e id, File* fp, const void* buff, uint32_t btw, uint32_t* bw, ReqOptions_e options), (override));
    MOCK_METHOD(FileStatus_e, writeAndSync, (ManagerId_e id, File* fp, const void* buff, uint32_t btw, ReqOptions_e options), (override));
