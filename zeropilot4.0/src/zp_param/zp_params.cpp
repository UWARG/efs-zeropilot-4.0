...
void init() {
    ...
    initParam(ZP_PARAM_ID::PSC_POSZ_P, "PSC_POSZ_P", 0.4f, MAV_PARAM_TYPE_REAL32);

    initParam(ZP_PARAM_ID::PSC_VELZ_P, "PSC_VELZ_P", 1.0f, MAV_PARAM_TYPE_REAL32);
    ...
    initParam(ZP_PARAM_ID::PSC_ACCZ_P, "PSC_ACCZ_P", 0.1f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::PSC_ACCZ_I, "PSC_ACCZ_I", 0.2f, MAV_PARAM_TYPE_REAL32);
