...
void init() {
    ...
    initParam(ZP_PARAM_ID::ATC_RAT_RLL_P, "ATC_RAT_RLL_P", 0.12f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ATC_RAT_RLL_I, "ATC_RAT_RLL_I", 0.12f, MAV_PARAM_TYPE_REAL32);
    ...
    initParam(ZP_PARAM_ID::ATC_RAT_PIT_P, "ATC_RAT_PIT_P", 0.12f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ATC_RAT_PIT_I, "ATC_RAT_PIT_I", 0.12f, MAV_PARAM_TYPE_REAL32);
