...
void init() {
    ...
    initParam(ZP_PARAM_ID::ROLL_LIMIT_DEG, "ROLL_LIMIT_DEG", 45.0f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::PTCH_LIMIT_DEG, "PTCH_LIMIT_DEG", 20.0f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::YAW_LIMIT_DEG, "YAW_LIMIT_DEG", 20.0f, MAV_PARAM_TYPE_REAL32);
