...
void init() {
    ...
    #ifdef QUADCOPTER
    initParam(ZP_PARAM_ID::ACT_RLL_P, "ACT_RLL_P", 0.0012f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_RLL_I, "ACT_RLL_I", 0.0012f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_RLL_D, "ACT_RLL_D", 0.000045f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_RLL_TAU, "ACT_RLL_TAU", 0.020f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_RLL_IMAX, "ACT_RLL_IMAX", 50, MAV_PARAM_TYPE_UINT8);

    initParam(ZP_PARAM_ID::ACT_PTCH_P, "ACT_PTCH_P", 0.0012f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_PTCH_I, "ACT_PTCH_I", 0.0012f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_PTCH_D, "ACT_PTCH_D", 0.00007f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_PTCH_TAU, "ACT_PTCH_TAU", 0.020f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_PTCH_IMAX, "ACT_PTCH_IMAX", 50, MAV_PARAM_TYPE_UINT8);

    initParam(ZP_PARAM_ID::ACT_YAW_P, "ACT_YAW_P", 0.006f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_YAW_I, "ACT_YAW_I", 0.006f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_YAW_D, "ACT_YAW_D", 0.00000f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_YAW_TAU, "ACT_YAW_TAU", 0.020f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_YAW_IMAX, "ACT_YAW_IMAX", 50, MAV_PARAM_TYPE_UINT8);
    #endif
    ...
    initParam(ZP_PARAM_ID::ROLL_LIMIT_RATE, "ROLL_LIMIT_RATE", 200.0f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::PTCH_LIMIT_RATE, "PTCH_LIMIT_RATE", 200.0f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::YAW_LIMIT_RATE, "YAW_LIMIT_RATE", 200.0f, MAV_PARAM_TYPE_REAL32);
