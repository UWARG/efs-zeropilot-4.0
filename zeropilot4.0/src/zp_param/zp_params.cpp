...
void init() {
    ...
    #ifdef QUADCOPTER
    initParam(ZP_PARAM_ID::ATC_RATE_RLL_P, "ATC_RATE_RLL_P", 0.06875f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ATC_RATE_RLL_I, "ATC_RATE_RLL_I", 0.06875f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ATC_RATE_RLL_D, "ATC_RATE_RLL_D", 0.00257f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ATC_RATE_RLL_TAU, "ATC_RATE_RLL_TAU", 0.020f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ATC_RATE_RLL_IMAX, "ATC_RATE_RLL_IMAX", 50, MAV_PARAM_TYPE_UINT8);

    initParam(ZP_PARAM_ID::ATC_RATE_PTCH_P, "ATC_RATE_PTCH_P", 0.06875f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ATC_RATE_PTCH_I, "ATC_RATE_PTCH_I", 0.06875f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ATC_RATE_PTCH_D, "ATC_RATE_PTCH_D", 0.004f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ATC_RATE_PTCH_TAU, "ATC_RATE_PTCH_TAU", 0.020f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ATC_RATE_PTCH_IMAX, "ATC_RATE_PTCH_IMAX", 50, MAV_PARAM_TYPE_UINT8);

    initParam(ZP_PARAM_ID::ATC_RATE_YAW_P, "ATC_RATE_YAW_P", 0.3438f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ATC_RATE_YAW_I, "ATC_RATE_YAW_I", 0.3438f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ATC_RATE_YAW_D, "ATC_RATE_YAW_D", 0.0f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ATC_RATE_YAW_TAU, "ATC_RATE_YAW_TAU", 0.020f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ATC_RATE_YAW_IMAX, "ATC_RATE_YAW_IMAX", 50, MAV_PARAM_TYPE_UINT8);
    #endif
