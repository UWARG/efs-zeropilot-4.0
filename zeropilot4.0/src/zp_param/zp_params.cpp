...
void init() {
    ...
    initParam(ZP_PARAM_ID::ATC_RAT_RLL_P, "ATC_RAT_RLL_P", 0.06875f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ATC_RAT_RLL_I, "ATC_RAT_RLL_I", 0.06875f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ATC_RAT_RLL_D, "ATC_RAT_RLL_D", 0.00257f, MAV_PARAM_TYPE_REAL32);
    ...
    initParam(ZP_PARAM_ID::ATC_RAT_PIT_P, "ATC_RAT_PIT_P", 0.06875f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ATC_RAT_PIT_I, "ATC_RAT_PIT_I", 0.06875f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ATC_RAT_PIT_D, "ATC_RAT_PIT_D", 0.004f, MAV_PARAM_TYPE_REAL32);
    ...
    initParam(ZP_PARAM_ID::ATC_ANG_RLL_P, "ATC_ANG_RLL_P", 2.0f, MAV_PARAM_TYPE_REAL32);
    ...
    initParam(ZP_PARAM_ID::ATC_ANG_PTCH_P, "ATC_ANG_PTCH_P", 2.0f, MAV_PARAM_TYPE_REAL32);
