...
void init() {
    ...
    initParam(ZP_PARAM_ID::BATT_LOW_VOLT, "BATT_LOW_VOLT", 14.0f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::BATT_CRT_VOLT, "BATT_CRT_VOLT", 13.6f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::BATT_CAPACITY, "BATT_CAPACITY", 3300.0f, MAV_PARAM_TYPE_REAL32);
