...
void init() {
    ...
    initParam(ZP_PARAM_ID::ATC_ANG_RLL_P, "ATC_ANG_RLL_P", 0.6f, MAV_PARAM_TYPE_REAL32);
    ...
    initParam(ZP_PARAM_ID::ATC_ANG_PTCH_P, "ATC_ANG_PTCH_P", 0.6f, MAV_PARAM_TYPE_REAL32);
