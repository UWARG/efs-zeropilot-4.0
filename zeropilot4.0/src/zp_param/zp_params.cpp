...
void init() {
    ...
    #ifdef QUADCOPTER
    initParam(ZP_PARAM_ID::ACT_RLL_P, "ACT_RLL_P", 0.06875f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_RLL_I, "ACT_RLL_I", 0.06875f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_RLL_D, "ACT_RLL_D", 0.00257f, MAV_PARAM_TYPE_REAL32);
    ...
    initParam(ZP_PARAM_ID::ACT_PTCH_P, "ACT_PTCH_P", 0.06875f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_PTCH_I, "ACT_PTCH_I", 0.06875f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_PTCH_D, "ACT_PTCH_D", 0.004f, MAV_PARAM_TYPE_REAL32);
    ...
    initParam(ZP_PARAM_ID::ACT_YAW_P, "ACT_YAW_P", 0.3438f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_YAW_I, "ACT_YAW_I", 0.3438f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_YAW_D, "ACT_YAW_D", 0.0f, MAV_PARAM_TYPE_REAL32);
