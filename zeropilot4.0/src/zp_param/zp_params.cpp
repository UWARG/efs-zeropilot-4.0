...
void init() {
    ...
    initParam(ZP_PARAM_ID::FFT_MINHZ, "FFT_MINHZ", 50.0f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::INS_HNTCH_BW, "INS_HNTCH_BW", 20.0f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::INS_HNTCH_ATT, "INS_HNTCH_ATT", 20.0f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::INS_HNTCH_HMNCS, "INS_HNTCH_HMNCS", 0x0003, MAV_PARAM_TYPE_UINT16);
}
