...
void init() {
    ...
    #ifdef QUADCOPTER
    initParam(ZP_PARAM_ID::ACT_RATE_RLL_P, "ACT_RATE_RLL_P", 0.06875f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_RATE_RLL_I, "ACT_RATE_RLL_I", 0.06875f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_RATE_RLL_D, "ACT_RATE_RLL_D", 0.00257f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_RATE_RLL_TAU, "ACT_RATE_RLL_TAU", 0.020f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_RATE_RLL_IMAX, "ACT_RATE_RLL_IMAX", 50, MAV_PARAM_TYPE_UINT8);

    initParam(ZP_PARAM_ID::ACT_RATE_PTCH_P, "ACT_RATE_PTCH_P", 0.06875f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_RATE_PTCH_I, "ACT_RATE_PTCH_I", 0.06875f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_RATE_PTCH_D, "ACT_RATE_PTCH_D", 0.004f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_RATE_PTCH_TAU, "ACT_RATE_PTCH_TAU", 0.020f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_RATE_PTCH_IMAX, "ACT_RATE_PTCH_IMAX", 50, MAV_PARAM_TYPE_UINT8);

    initParam(ZP_PARAM_ID::ACT_RATE_YAW_P, "ACT_RATE_YAW_P", 0.3438f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_RATE_YAW_I, "ACT_RATE_YAW_I", 0.3438f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_RATE_YAW_D, "ACT_RATE_YAW_D", 0.0f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_RATE_YAW_TAU, "ACT_RATE_YAW_TAU", 0.020f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_RATE_YAW_IMAX, "ACT_RATE_YAW_IMAX", 50, MAV_PARAM_TYPE_UINT8);

    initParam(ZP_PARAM_ID::ACT_ANG_RLL_P, "ACT_ANG_RLL_P", 0.0f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_ANG_RLL_I, "ACT_ANG_RLL_I", 0.0f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_ANG_RLL_D, "ACT_ANG_RLL_D", 0.0f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_ANG_RLL_TAU, "ACT_ANG_RLL_TAU", 0.020f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_ANG_RLL_IMAX, "ACT_ANG_RLL_IMAX", 50, MAV_PARAM_TYPE_UINT8);

    initParam(ZP_PARAM_ID::ACT_ANG_PTCH_P, "ACT_ANG_PTCH_P", 0.0f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_ANG_PTCH_I, "ACT_ANG_PTCH_I", 0.0f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_ANG_PTCH_D, "ACT_ANG_PTCH_D", 0.0f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_ANG_PTCH_TAU, "ACT_ANG_PTCH_TAU", 0.020f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ACT_ANG_PTCH_IMAX, "ACT_ANG_PTCH_IMAX", 50, MAV_PARAM_TYPE_UINT8);
    
    // verify these default values
    initParam(ZP_PARAM_ID::ROLL_LIMIT_RATE, "ROLL_LIMIT_RATE", 3.5f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::PTCH_LIMIT_RATE, "PTCH_LIMIT_RATE", 3.5f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::YAW_LIMIT_RATE, "YAW_LIMIT_RATE", 3.5f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::ROLL_LIMIT_ANG, "ROLL_LIMIT_ANG", 20.0f, MAV_PARAM_TYPE_REAL32);
    initParam(ZP_PARAM_ID::PTCH_LIMIT_ANG, "PTCH_LIMIT_ANG", 20.0f, MAV_PARAM_TYPE_REAL32);

    initParam(ZP_PARAM_ID::FLTMODE1, "FLTMODE1", static_cast<float>(FlightMode_e::ACRO), MAV_PARAM_TYPE_UINT32);
    initParam(ZP_PARAM_ID::FLTMODE2, "FLTMODE2", static_cast<float>(FlightMode_e::STABILIZE), MAV_PARAM_TYPE_UINT32);
