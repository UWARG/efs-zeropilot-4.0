...
namespace SITL_Driver_Configs {
    ...
    struct SITL_PowerModule_Config {
        ...
        static constexpr float BATTERY_INTERNAL_RESISTANCE_OHMS = 0.025f; // Simulated internal resistance of the battery in Ohms

        static constexpr float CURRENT_DRAW_IDLE = 5.0f; // Simulated current draw at idle in Amps
