...
CPP_SRCS += \
../boardfiles/override.cpp 

OBJS += \
./boardfiles/override.o 

CPP_DEPS += \
./boardfiles/override.d 


# Each subdirectory must supply rules for building sources it contributes
boardfiles/%.o boardfiles/%.su boardfiles/%.cyclo: ../boardfiles/%.cpp boardfiles/subdir.mk
...
clean: clean-boardfiles

clean-boardfiles:
	-$(RM) ./boardfiles/override.cyclo ./boardfiles/override.d ./boardfiles/override.o ./boardfiles/override.su

.PHONY: clean-boardfiles
